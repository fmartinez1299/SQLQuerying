...
-- 8. Find all apps with a min_installs not exceeding 50, that have a rating. Order your results by highest rated first
...
SELECT app_name, reviews FROM analytics WHERE price BETWEEN 0.1 AND 1 ORDER BY reviews DESC LIMIT 10;
